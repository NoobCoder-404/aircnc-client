      ...
      <div className="md:flex justify-between sm:mx-10 md:mx-20 px-4 lg:mx-40 py-12">
        ...
        <div className="flex-1 max-w-lg">
          ...
          <div>
            <div className="flex flex-col items-start pb-4 my-2 mt-8 mx-auto max-w-7xl sm:flex-row">
              ...
              <div className="flex-grow prose sm:text-left prose-md">
                ...
                <p className="text-gray-400">You will have the condominium to yourself.</p>
              </div>
            </div>
          ...
          <div className="mt-4 text-gray-500">
            <p>
              It's newly constructed 7 storied building maintaining building code by a locally
              famous architect. Enough lights and natural air are playing here. The place
              (apartment) is calm and noise free. You'll love my place for its lovely and bright
              looks comfortable stay.
            </p>
            <p>
              Bangladesh is a beauty with its six seasons and green. The people are hospitable and
              worm.It's newly constructed 7 storied building maintaining building code by a locally
              famous architect. Enough lights and natural air are playing here. The place
              (apartment) is calm and noise free. You'll love my place for its lovely and bright
              looks comfortable Stay.
            </p>
          ...
          <div>
            ...
            <div className="flex gap-1 mb-2">
              <StarIcon className="h4 w-4 text-green-500" /> <span>4.8 (10 reviews)</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 md:w-1/2 lg:w-1/3 w-full h-full rounded shadow-lg">
          ...
          <p className="text-center text-gray-400 mb-6">You won't be charged yet!</p>
        </div>
      </div>
    </div>
  );
