...
const ReviewHouse = ({ setSelectedIndex }) => {
  return (
    <>
      <h1 className="text-gray-900 title-font text-4xl font-medium">Review house rules</h1>
      <br />
      <h3 className="text-gray-900 title-font text-xl font-medium">3 nights in Dhaka</h3>
      ...
      <div>
        <div className="flex flex-col items-center my-2 mt-8 mx-auto max-w-7xl sm:flex-row">
          ...
          <div className="flex-grow prose sm:text-left prose-md">
            <p className="text-gray-800 text-medium">Suitable for children and infants</p>
          </div>
        </div>
