...
const SearchCard = () => {
  return (
    <div className="flex overflow-hidden bg-white rounded-lg shadow-lg my-4">
      <Link to="/service-details" className="block relative h-48 rounded overflow-hidden w-1/2">
        <img
          alt="e-commerce"
      ...
      <div className="w-1/2 px-2 flex flex-col justify-around">
        <div>
          <h2 className="text-gray-900 title-font text-lg font-medium">Unique Cob Cottage</h2>
